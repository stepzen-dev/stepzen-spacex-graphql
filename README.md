...
This project is a React app spun up with a StepZen connection to SpaceX's GraphQL API. It demonstrates how you can connect create a StepZen layer for a GraphQL API with a React frontend.
